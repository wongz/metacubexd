...
## [1.246.0](https://github.com/wongz/metacubexd/compare/v1.245.0...v1.246.0) (2026-04-20)


### Features

* add auto-switch endpoint when connection fails ([#1735](https://github.com/wongz/metacubexd/issues/1735)) ([36dbe98](https://github.com/wongz/metacubexd/commit/36dbe9809c4ff55dffad428393cf4182dcca77b0))
* add changelog component and update version handling ([bf7c535](https://github.com/wongz/metacubexd/commit/bf7c53550e5e305f104b92d542b3755c33da8c4f))
* add Connections page with table, pagination, and toolbar components ([07f4bf4](https://github.com/wongz/metacubexd/commit/07f4bf4e09e259d702a63afe3765c3c36a4baf17))
* add custom font theme variables for Twemoji and system fonts ([af8b3e2](https://github.com/wongz/metacubexd/commit/af8b3e2f7003e9831aa3c8a941f5bd5bb8fefc41))
* add Data Usage tracking table with real-time monitoring ([#1671](https://github.com/wongz/metacubexd/issues/1671)) ([0762d93](https://github.com/wongz/metacubexd/commit/0762d93d7d5551ac2851dbbc9807de8ba701f848))
* add DataTable component for enhanced table rendering ([3636524](https://github.com/wongz/metacubexd/commit/36365247e113798eb9670084acc9e5f3e0c7842a))
* add docker setup action to release workflow ([1d8c1f1](https://github.com/wongz/metacubexd/commit/1d8c1f10c9e183dfc051ea14debe6ccd7d356270))
* add GlobalTrafficIndicator component for real-time traffic monitoring ([ef49818](https://github.com/wongz/metacubexd/commit/ef498180b96c76bcd476874548c781f0b6eb8f11))
* add inbound user information to connection details ([#1861](https://github.com/wongz/metacubexd/issues/1861)) ([71f577e](https://github.com/wongz/metacubexd/commit/71f577ed347b5ab262bef7196682f5c8e2a27cbf))
* add IP information types and network topology interfaces ([dd4d49a](https://github.com/wongz/metacubexd/commit/dd4d49a2a9c410fc985c478c9ae6d0dd2f7be3cb))
* add new flow chart to overview page ([080560e](https://github.com/wongz/metacubexd/commit/080560e2a54121b27d66986413a9b0a66d33f1a8))
* add onSelect prop to ProxyNodePreview and ProxyPreviewDots for improved interactivity ([f2a5b92](https://github.com/wongz/metacubexd/commit/f2a5b929dacb4c846785ce0321756f84b7cf8513))
* add reset settings buttons for XD config and proxies settings ([#1747](https://github.com/wongz/metacubexd/issues/1747)) ([70eaf4f](https://github.com/wongz/metacubexd/commit/70eaf4f499862366969140108e31c7f8e99bf098))
* add screenshot generation script for CI ([#1736](https://github.com/wongz/metacubexd/issues/1736)) ([0ded7f0](https://github.com/wongz/metacubexd/commit/0ded7f072abdaa1c99722427d931932f3c5064fd))
* add sidebar component and enhance UI interactions ([e6698f5](https://github.com/wongz/metacubexd/commit/e6698f567213678d532353ad77c029401e5eaed9))
* add toggle for NetworkTopology visibility in overview page ([505c98e](https://github.com/wongz/metacubexd/commit/505c98e4b259938bce2c65638ea4cd8585c7e611))
* change mobile navbar to bottom nav ([#1610](https://github.com/wongz/metacubexd/issues/1610)) ([e111091](https://github.com/wongz/metacubexd/commit/e111091d37fae12a6c2d0f832d27016cbd29d085))
* **Changelog:** implement frontend and backend release fetching for changelog timeline ([0f261a6](https://github.com/wongz/metacubexd/commit/0f261a62b26c1ab8c43d59a7ca7808d5f48ae601))
* **config:** add recommendation settings and fix shortcut button layout ([a6181c6](https://github.com/wongz/metacubexd/commit/a6181c6ecdf87a91bc0da86025b41e122c8e8bac))
* connections table virtual scroll ([fa3d024](https://github.com/wongz/metacubexd/commit/fa3d024b16b9c0cbeb84d1f0b9117d6be8cb096d))
* **ConnectionsToolbar:** improve layout and accessibility of controls ([1b8b78b](https://github.com/wongz/metacubexd/commit/1b8b78bc186670e8f388d412898952a8a2ba9320))
* **DataUsageTable:** add grouping and sorting functionality for data usage entries ([caa46bd](https://github.com/wongz/metacubexd/commit/caa46bd6ebb79f61a67a79aef40a0ba4013ad826))
* dns query supports more record types ([#1532](https://github.com/wongz/metacubexd/issues/1532)) ([4ec76c7](https://github.com/wongz/metacubexd/commit/4ec76c7be214d4f90a32af5e8af93ef73fe774d0))
* enable docker feature containerd-snapshotter ([d30e625](https://github.com/wongz/metacubexd/commit/d30e62570f5664707964fce9fe7eecab9fa72a79))
* enhance ConnectionsSettingsModal with sortable columns and improved visibility handling ([a1ce722](https://github.com/wongz/metacubexd/commit/a1ce722517a5c3a52314dbde1fb009f2343709f7))
* enhance latency retrieval logic and improve history fetching in useProxies ([33573e3](https://github.com/wongz/metacubexd/commit/33573e310fc4c90de2baa7a8fe82ad6f3f5bdbcb))
* enhance MockWebSocket to send initial historical data for traffic and memory metrics ([b133034](https://github.com/wongz/metacubexd/commit/b133034d2715e1c50e8c96e44b761ff9d93729e7))
* enhance ProxyNodeCard badge opacity and font weight ([3fdf74d](https://github.com/wongz/metacubexd/commit/3fdf74d57a6259237ad482b1c4b5ca85a9762ac1)), closes [#1361](https://github.com/wongz/metacubexd/issues/1361)
* enhance real-time data handling for traffic and memory metrics with chart history management ([501f95c](https://github.com/wongz/metacubexd/commit/501f95c4b67cad4449968633dd36e944fdbdf636))
* Flush DNS Cache ([#1768](https://github.com/wongz/metacubexd/issues/1768)) ([c7f702b](https://github.com/wongz/metacubexd/commit/c7f702b29d483f44ec31abddc2baa2376f756374))
* font switching feature and use the Twemoji font that only includes flags ([#1547](https://github.com/wongz/metacubexd/issues/1547)) ([aab2d5e](https://github.com/wongz/metacubexd/commit/aab2d5e620e36db5236b93544ae5be32b9cefbae))
* format IPv6 and adjust style ([#1562](https://github.com/wongz/metacubexd/issues/1562)) ([0c52c30](https://github.com/wongz/metacubexd/commit/0c52c30efdd7240a86267592c5e691fa23484671))
* implement theme support for Highcharts and update related components ([7e7c1ce](https://github.com/wongz/metacubexd/commit/7e7c1ced46ce61f37524946e82e5884ca304764f))
* implement ThemeSelector component and integrate it into config page ([f70d415](https://github.com/wongz/metacubexd/commit/f70d415e902ec6e547fc39ab22421d371f89ddb5))
* implement virtual scrolling for rules and providers ([6ecb3ef](https://github.com/wongz/metacubexd/commit/6ecb3efc61789128531b3067fac93edcb4dffefb))
* improve server startup logic in screenshot script ([311d69e](https://github.com/wongz/metacubexd/commit/311d69e60d332891dbc02190933402f57c806d23))
* integrate Floating UI for tooltips in Versions component ([10cd114](https://github.com/wongz/metacubexd/commit/10cd1147ae8293ac61f7cd1cebfc53720ffd2d23))
* **latency:** enhance loading state with proxy latency updates ([69015f1](https://github.com/wongz/metacubexd/commit/69015f1187fc63fc28a550569eb9f3746a4d846c))
* **Logs:** add log type extraction and update column headers for improved clarity ([a2d8081](https://github.com/wongz/metacubexd/commit/a2d80815ecb5183cc31c335472a8f5abd9be9355))
* make proxy preview auto-switch threshold configurable ([#1817](https://github.com/wongz/metacubexd/issues/1817)) ([a6cbc2c](https://github.com/wongz/metacubexd/commit/a6cbc2c8c3dedca5fdf25d84947f33983b3e934b))
* **mobile:** Add bottom navigation option for mobile view ([#1805](https://github.com/wongz/metacubexd/issues/1805)) ([90ea708](https://github.com/wongz/metacubexd/commit/90ea708eb77355f376042fc793103df1c3458aa6))
* **NetworkTopology:** adjust tree rendering width for better layout ([dcfa068](https://github.com/wongz/metacubexd/commit/dcfa068a83b8d728a77269da5c6d3f68043f40b8))
* prioritize proxy groups in sorting ([#1929](https://github.com/wongz/metacubexd/issues/1929)) ([9d3b079](https://github.com/wongz/metacubexd/commit/9d3b0794458b80a2dfb3db95242a267271c66135))
* **proxies:** add smart node recommendation with batch testing and scoring ([14df403](https://github.com/wongz/metacubexd/commit/14df4033908201761ae802da14c4ec51f96ee8e8))
* **Proxies:** implement display mode toggle for proxy nodes and add ProxyNodeListItem component ([b83f7b9](https://github.com/wongz/metacubexd/commit/b83f7b9fb67e92777ea33ad57f418df246efa4bd))
* **proxies:** restructure layout of ProxyNode display for improved readability ([9c0da7a](https://github.com/wongz/metacubexd/commit/9c0da7a3897723d4de9d05867cf2d07a81481115))
* **proxy-node-card:** add localization for latency history message and improve tooltip design ([9aabdb2](https://github.com/wongz/metacubexd/commit/9aabdb27dc096ae2880388d7dbdbfa4558dc1929))
* **proxy-node:** add UDP indicator and improve special types display ([cae651f](https://github.com/wongz/metacubexd/commit/cae651fa1cb15a0d620503741039b7a9f49f486b))
* **proxy-node:** update ProxyNodeCard styling and structure for improved layout and clarity ([8c5d184](https://github.com/wongz/metacubexd/commit/8c5d1845a7f5e780014f2f8288f6e5602687225a))
* re-trigger release-please ([94b358d](https://github.com/wongz/metacubexd/commit/94b358d5dfdae03607dabbef34c20bcb0d22efa5))
* refactor components to use solid-query for data fetching and state management ([8df4960](https://github.com/wongz/metacubexd/commit/8df49608f654a5698fdda34b3b4e61c237152fd4))
* refactor routing and endpoint checks across multiple pages ([e9faa08](https://github.com/wongz/metacubexd/commit/e9faa08b92d2414bb03c30e02517a7c222e88a36))
* release ([ed4a1da](https://github.com/wongz/metacubexd/commit/ed4a1da1afc5d4e00a7186c5271326313b8036e0))
* release ([0dcaa83](https://github.com/wongz/metacubexd/commit/0dcaa838cd3bb2bd1a0192057f1cb33d2a6f5f64))
* rename url field to 'metacubexd-endpoint-url' and enhance form accessibility ([70598d7](https://github.com/wongz/metacubexd/commit/70598d7ba9a9c088232837facbde44c5b4deb9bb))
* Responsive connections table for mobile with sort controls ([#1684](https://github.com/wongz/metacubexd/issues/1684)) ([8d97c5a](https://github.com/wongz/metacubexd/commit/8d97c5ad39362fddb5ec2f2153111a2e7eba998d))
* **rules:** add rule toggle and match stats ([#1943](https://github.com/wongz/metacubexd/issues/1943)) ([acdcf3a](https://github.com/wongz/metacubexd/commit/acdcf3a58aa6a2cf5372a205a27f6d8dfb40764d))
* support linux/arm64 docker image ([#1851](https://github.com/wongz/metacubexd/issues/1851)) ([e5c6875](https://github.com/wongz/metacubexd/commit/e5c68759993d1d312ae07b76eaa7467cd265c31d)), closes [#1815](https://github.com/wongz/metacubexd/issues/1815)
* Support setting default backend URL via environment variable ([#1733](https://github.com/wongz/metacubexd/issues/1733)) ([f610ffc](https://github.com/wongz/metacubexd/commit/f610ffc85a05ec660e21bad36998441dc6bf08fd))
* **test:** add comprehensive unit test coverage for stores, composables, and utils ([c211ea5](https://github.com/wongz/metacubexd/commit/c211ea56d22ec391b997e3daa328739ac2eff139))
* UI/UX enhancements, marquee effects, and default start page ([#1892](https://github.com/wongz/metacubexd/issues/1892)) ([36c14a1](https://github.com/wongz/metacubexd/commit/36c14a1a1369a0f434b4cc69c7e38f1a9d285f5b))
* **ui:** enhance UI components and layout rendering ([#1899](https://github.com/wongz/metacubexd/issues/1899)) ([0ef2d84](https://github.com/wongz/metacubexd/commit/0ef2d84d749171b343728433de6894fbde313167))
* update chart options and components to use ECharts ([#1681](https://github.com/wongz/metacubexd/issues/1681)) ([52fe0ed](https://github.com/wongz/metacubexd/commit/52fe0ed4d86aa1b8f6cd1a6e55d04a8868bc172c))
* update CI token, trigger new release ([7c35df9](https://github.com/wongz/metacubexd/commit/7c35df9bb8ec2baf1fb41c5f16c74528b748048c))
* update nuxt.config.ts for relative asset paths and adjust GitHub workflow for base URL ([07fe7e5](https://github.com/wongz/metacubexd/commit/07fe7e508b0d6579d984b1c0bdcacdd0146811f1))
* update project configuration and enhance components ([c70c2e8](https://github.com/wongz/metacubexd/commit/c70c2e88d10c04d6e8449b6d787faebf8b355bfc))
* update ProxyNodeCard badge styling ([e44e190](https://github.com/wongz/metacubexd/commit/e44e190aaf77d6247289285600b04860ed7d72b3))
* update release workflow to support multi-platform builds ([a377cf2](https://github.com/wongz/metacubexd/commit/a377cf29b4ba05ae25a98803a0721201ca38b40c))
* update release workflow to use macOS runner for compatibility ([2a327af](https://github.com/wongz/metacubexd/commit/2a327af06229e3306d912a6a3323f0a482f87eee))
* update release workflow to use Ubuntu runner for consistency ([d1283df](https://github.com/wongz/metacubexd/commit/d1283df72b606885bf32793a136051572a606a97))
* update screenshot generation script and improve package.json commands ([bb51c53](https://github.com/wongz/metacubexd/commit/bb51c53fa1dbc0e118abb311b78f9d2413d9cc25))
* **useConnectionsTable:** optimize data filtering and memoization for improved performance ([9ee4aec](https://github.com/wongz/metacubexd/commit/9ee4aeca8d53e875fc3bd96484b4c902f34a8cfa))
* verify API endpoint with `/version` ([#1568](https://github.com/wongz/metacubexd/issues/1568)) ([#1569](https://github.com/wongz/metacubexd/issues/1569)) ([01e130b](https://github.com/wongz/metacubexd/commit/01e130bf2ac5708c28a0c01a9287bd53addb9a08))
* **Versions, config:** enhance layout and update styles for better UI consistency ([1f5033b](https://github.com/wongz/metacubexd/commit/1f5033b53db627581d3236ee63bdabe8f757a5e0))
* **versions:** enable force update by default, closes [#1376](https://github.com/wongz/metacubexd/issues/1376) ([fd11412](https://github.com/wongz/metacubexd/commit/fd114127d62556278825d6837585c49ef6e07f80))
* **versions:** update Tooltip.Trigger classes for better styling consistency ([9ad414c](https://github.com/wongz/metacubexd/commit/9ad414c46baf5755aa26bbe36000b61266945879))


### Bug Fixes

* [#1504](https://github.com/wongz/metacubexd/issues/1504) [#1381](https://github.com/wongz/metacubexd/issues/1381) [#1428](https://github.com/wongz/metacubexd/issues/1428) ([#1540](https://github.com/wongz/metacubexd/issues/1540)) ([c40b139](https://github.com/wongz/metacubexd/commit/c40b139cda0ca546ddaa8509101c519377bf9529))
* active menu item ([#1523](https://github.com/wongz/metacubexd/issues/1523)) ([d4398f1](https://github.com/wongz/metacubexd/commit/d4398f16a54854c4e6169eec10357546208e9d16))
* add cleanupOutdatedCaches to prevent iOS Web Clips stale cache issues ([#1744](https://github.com/wongz/metacubexd/issues/1744)) ([5783791](https://github.com/wongz/metacubexd/commit/5783791592f7e738eeaf224a29931091926ea042))
* add missing token for attaching GitHub release artifacts ([f1525f6](https://github.com/wongz/metacubexd/commit/f1525f67a565fd00202d8baae351abe67b36d085))
* add safe-area-inset-top to modal header for Safari compatibility ([#1745](https://github.com/wongz/metacubexd/issues/1745)) ([10026de](https://github.com/wongz/metacubexd/commit/10026de25f2919f34dad43b3b7a2508c6e3217fc))
* bg color ([#1355](https://github.com/wongz/metacubexd/issues/1355)) ([6c84d16](https://github.com/wongz/metacubexd/commit/6c84d16966ae265b4410b7117dab867062da5ffa))
* closes [#1455](https://github.com/wongz/metacubexd/issues/1455) ([5a0b25d](https://github.com/wongz/metacubexd/commit/5a0b25d1c8b6deb713295aa5951b1e5cc5102351))
* correct ConnectionsPagination component name ([a6f51d4](https://github.com/wongz/metacubexd/commit/a6f51d4334f5a0026e87d7e0f661600d64b29caa))
* correct regex in compareVersions that broke version update detection ([#1927](https://github.com/wongz/metacubexd/issues/1927)) ([8508936](https://github.com/wongz/metacubexd/commit/85089366bd4445c93df578eed56f96cc22354b61))
* correct traffic chart color order and unregister old service workers ([6fa7187](https://github.com/wongz/metacubexd/commit/6fa7187e659aa77e4857477d07799a26a8fcb0ee))
* **deps:** downgrade @types/node from 24.10.1 to 24.10.0 ([e13b318](https://github.com/wongz/metacubexd/commit/e13b318a6636479e9a6890dd9f6665afbec77880))
* **deps:** override vulnerable transitive dependencies ([252153c](https://github.com/wongz/metacubexd/commit/252153c59f31fa03f38d54a6fdcb16b22ce9a04a))
* **deps:** override vulnerable transitive dependencies ([4b38650](https://github.com/wongz/metacubexd/commit/4b38650f5ef7d90a8a03bec17850eeeea59ac5f0))
* **deps:** resolve dependabot security vulnerabilities ([f4ed011](https://github.com/wongz/metacubexd/commit/f4ed011d9511e2c4aea62f99dfc109ac16c4d384))
* disable app manifest for browser compat and show endpoint errors ([#1891](https://github.com/wongz/metacubexd/issues/1891), [#1859](https://github.com/wongz/metacubexd/issues/1859)) ([b643425](https://github.com/wongz/metacubexd/commit/b64342589863932090aafbcfcefcbb37e179b7dd))
* **e2e:** fix keyboard shortcuts and test stability ([8c078d4](https://github.com/wongz/metacubexd/commit/8c078d4da7b42a66f383584f8ad3e7c3e49c150e))
* **e2e:** use attached state for waitForSelector to avoid visibility timeout ([7b56fca](https://github.com/wongz/metacubexd/commit/7b56fca74d35a47d213ad355654bd3b75360bc71))
* ensure config.js loads synchronously and fix saved endpoints display ([428d6f4](https://github.com/wongz/metacubexd/commit/428d6f4febe7af38fd1d8185fdb36d6a653f336d))
* handle unreachable backend gracefully instead of blocking UI ([#1896](https://github.com/wongz/metacubexd/issues/1896)) ([a373690](https://github.com/wongz/metacubexd/commit/a3736903dcbd1d41dbe1d63262c9d57375024398))
* improve connections table layout and styling ([#1712](https://github.com/wongz/metacubexd/issues/1712)) ([d36ac5f](https://github.com/wongz/metacubexd/commit/d36ac5f6fdc94f4bab3e8fad54b0cdaeb36e49c7))
* improve layout and truncation for IPInfoCard and GlobalTrafficIndicator components ([3d9aaea](https://github.com/wongz/metacubexd/commit/3d9aaea888aac63251c5a6d731ea263b742d5ee7))
* improve proxy node card UX and overview accuracy ([#1846](https://github.com/wongz/metacubexd/issues/1846), [#1847](https://github.com/wongz/metacubexd/issues/1847)) ([7f803a9](https://github.com/wongz/metacubexd/commit/7f803a972ea206341298d8f8fb8ad17095700ea7))
* improve UI components and fix various issues ([b57eb3b](https://github.com/wongz/metacubexd/commit/b57eb3b0ae7bb82b80e8a1ff30c8f1c956ece4b6))
* move proxy group filter from speedGroupByName to overview page ([#1847](https://github.com/wongz/metacubexd/issues/1847)) ([#1877](https://github.com/wongz/metacubexd/issues/1877)) ([b5c6eb6](https://github.com/wongz/metacubexd/commit/b5c6eb669b7690a1ad44380e822f9ffe137a3f37))
* **overview:** update stats component background and change chart type for better visual clarity ([dc1df6c](https://github.com/wongz/metacubexd/commit/dc1df6c382346e90d3657dfc1e953a5caa40aa41))
* prevent iOS Safari rapid page refresh loop ([#1740](https://github.com/wongz/metacubexd/issues/1740)) ([e17fe4a](https://github.com/wongz/metacubexd/commit/e17fe4aadb734cf08aa387d01c77eef2fa31dc23))
* prevent mobile header scroll-away and replace inline styles with Tailwind ([7914ad5](https://github.com/wongz/metacubexd/commit/7914ad5160e352cfc96bec7217ae17f9caa6fd1a))
* **release:** remove unnecessary load option from Docker build step ([fdff0ed](https://github.com/wongz/metacubexd/commit/fdff0edfc1a1e2b7d0862d90727d956441d8480d))
* remove gradient text effect that hides proxy group titles ([#1857](https://github.com/wongz/metacubexd/issues/1857)) ([a51a739](https://github.com/wongz/metacubexd/commit/a51a73913125b4aead507c679f2165ab35de50aa))
* remove popover animation from latency history tooltip ([9e0009c](https://github.com/wongz/metacubexd/commit/9e0009c9e116f8f8c0476bd3c023beb53be68ce5))
* resolve multiple issues ([#1834](https://github.com/wongz/metacubexd/issues/1834), [#1814](https://github.com/wongz/metacubexd/issues/1814), [#1485](https://github.com/wongz/metacubexd/issues/1485), [#1129](https://github.com/wongz/metacubexd/issues/1129)) ([6d473c7](https://github.com/wongz/metacubexd/commit/6d473c7aa623e2a887e80c58a8d2339baf62a8d8))
* resolve multiple UI bugs ([#1863](https://github.com/wongz/metacubexd/issues/1863), [#1849](https://github.com/wongz/metacubexd/issues/1849), [#1865](https://github.com/wongz/metacubexd/issues/1865)) ([a342249](https://github.com/wongz/metacubexd/commit/a34224969a5ebbc11348282206eda5db974a06fb))
* specify platforms directly in docker build step ([ab86845](https://github.com/wongz/metacubexd/commit/ab8684536cf84b4663eeefe09e8f50837dfc175f))
* **test:** exclude e2e tests from coverage command ([fd93b8d](https://github.com/wongz/metacubexd/commit/fd93b8d57ad84d7f6541fb5729f094c318b83796))
* **test:** fix test:unit script to exclude e2e tests correctly ([e1bf292](https://github.com/wongz/metacubexd/commit/e1bf2922b8f60af390eca14dbe4bdce2793245a8))
* Twemoji does not work on iOS ([#1552](https://github.com/wongz/metacubexd/issues/1552)) ([c5eb4c0](https://github.com/wongz/metacubexd/commit/c5eb4c046f58cc81867af5cb0b56b82c80ab9543))
* update docker build platforms to linux/amd64 only ([a065ef5](https://github.com/wongz/metacubexd/commit/a065ef5d89fc83611a1aa8ce69c1d65e11dcaaea))
* update docker build step to load cache and specify platforms ([c18e6d4](https://github.com/wongz/metacubexd/commit/c18e6d43e572e7bf75d0a210484f8037f3d71bac))
* update e2e tests and screenshot selectors for new UI ([8c5785b](https://github.com/wongz/metacubexd/commit/8c5785b46510d62c0b6a2cc1ad0ecae5f3d62e57))
* update ky v2 API - prefixUrl to prefix ([#1942](https://github.com/wongz/metacubexd/issues/1942)) ([e76c7da](https://github.com/wongz/metacubexd/commit/e76c7da98bf5936da75517e1b2882af9e918f492))
* update project dependencies to latest versions for improved stability ([18eeb1c](https://github.com/wongz/metacubexd/commit/18eeb1cfdcc2cacb6650a49b72121a5f15f7d5d2))
* update tooltip position and adjust column width in Connections table ([#1694](https://github.com/wongz/metacubexd/issues/1694)) ([f565e7d](https://github.com/wongz/metacubexd/commit/f565e7d3d65e0b043b92033e1705ea5f9b1e1b91))
* use fixed positioning for latency tooltip to prevent page jitter ([#1856](https://github.com/wongz/metacubexd/issues/1856)) ([8648fb8](https://github.com/wongz/metacubexd/commit/8648fb897e61ceffdd32a3f79afefe3096eea04d))
* use semver comparison for version update checks ([#1868](https://github.com/wongz/metacubexd/issues/1868)) ([023030f](https://github.com/wongz/metacubexd/commit/023030fd741cbd7316afdc780503c28420133ce2))
* **versions:** disable update when none available or during update process ([e050d07](https://github.com/wongz/metacubexd/commit/e050d07de4fac94a6c695f660f9edeb7fc043a3c))
* **Versions:** increase z-index for frontend and backend tooltips ([1d22667](https://github.com/wongz/metacubexd/commit/1d2266713e2888bcf25dd42b7dbcfffc0bfebed5))
* **versions:** prevent update trigger during ongoing update process ([ed55418](https://github.com/wongz/metacubexd/commit/ed554188bd75eb86baf2e6f22c5d4c66097946f7))
* **versions:** reload page after successful update for frontend and backend ([edf0d47](https://github.com/wongz/metacubexd/commit/edf0d47eb55f34df4dfe2979f28a5d1c1b421e4c))
* virtual table render at bottom in Gecko engine based browser ([#1645](https://github.com/wongz/metacubexd/issues/1645)) ([62c9439](https://github.com/wongz/metacubexd/commit/62c9439a7b095a568f07d52707eef8cf002b0654))
